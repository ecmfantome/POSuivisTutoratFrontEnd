...
const SideNavbar: React.FC<SideBaRcomponentsProps> = ({
    body,
}) => {
  ...
  return (
     <div>
                <nav
                    className="relative md:left-0 md:block md:fixed md:top-0 md:bottom-0 md:overflow-y-auto md:flex-row md:flex-nowrap md:overflow-hidden shadow-xl bg-black flex flex-wrap  justify-between relative md:w-64 z-10"
                >
                    <div
                    ...
                    >
                        ...
                        <MenuItemComponent
                            ...
                            text="Dashboard"
                            svgIcon={(
                            <svg xmlns="http://www.w3.org/2000/svg" width={25} height={25} viewBox="0 0 24 24" fill="#F2901D">
                        ...
                        <MenuItemComponent
                                ...
                                isActive={isActive('/groupe')}// Actif
                            />
                            ...
                            <MenuItemComponent
                                ...
                                text="Module"
                                svgIcon={(
                                    <svg xmlns="http://www.w3.org/2000/svg" width={25} height={25} viewBox="0 0 24 24" fill="#F2901D"><path d="M21 4H7C5.89543 4 5 4.89543 5 6C5 7.10457 5.89543 8 7 8H21V21C21 21.5523 20.5523 22 20 22H7C4.79086 22 3 20.2091 3 18V6C3 3.79086 4.79086 2 7 2H20C20.5523 2 21 2.44772 21 3V4ZM20 7H7C6.44772 7 6 6.55228 6 6C6 5.44772 6.44772 5 7 5H20V7Z"></path></svg>
                                )}
                                isActive={isActive('/module')}// Actif
                            />
                            ...
                            <MenuItemComponent
                                ...
                                text="Planning"
                                svgIcon={(
                                    <svg xmlns="http://www.w3.org/2000/svg" width={25} height={25} viewBox="0 0 24 24" fill="#F2901D"><path d="M17 3H21C21.5523 3 22 3.44772 22 4V20C22 20.5523 21.5523 21 21 21H3C2.44772 21 2 20.5523 2 20V4C2 3.44772 2.44772 3 3 3H7V1H9V3H15V1H17V3ZM4 9V19H20V9H4ZM6 11H8V13H6V11ZM11 11H13V13H11V11ZM16 11H18V13H16V11Z"></path></svg>
                                )}
                                isActive={isActive('/planning')}// Actif
                            />
                        ...
                        <div className="logout absolute bottom-10 w-full px-6">
                            ...
                            >
                            <div
                                className="bg-[#F2901D] rounded-xl h-12 w-1/4 flex items-center justify-center absolute left-1 top-[4px] group-hover:w-full z-10 duration-500"
                            >

                                <svg xmlns="http://www.w3.org/2000/svg"  width="25px" height="25px" viewBox="0 0 24 24" fill="currentColor"><path d="M4 18H6V20H18V4H6V6H4V3C4 2.44772 4.44772 2 5 2H19C19.5523 2 20 2.44772 20 3V21C20 21.5523 19.5523 22 19 22H5C4.44772 22 4 21.5523 4 21V18ZM6 11H13V13H6V16L1 12L6 8V11Z"></path></svg>
                            </div>
